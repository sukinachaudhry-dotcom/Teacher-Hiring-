    ...
    <ScrollView style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View style={styles.aboutBox}>
        ...
        <Text style={styles.aboutText}>
          ...
          I have successfully guided many students at Progressive Public School
          to achieve excellent results and develop a strong interest in
      ...
      <View style={styles.btnRow}>
        <TouchableOpacity style={styles.chatBtn}>
          ...
          <Text  onPress={()=> navigation.navigate("Chat")} style={styles.chatText}> Chat with Teacher</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.extraBtnRow}>
        <TouchableOpacity style={styles.extraBtn}>
          <Icon name="description" size={18} color="purple" />
          <Text style={styles.extraText}> View Resume</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.extraBtn}>
          <Icon name="playlist-add" size={18} color="purple" />
          <Text  onPress={()=> navigation.navigate("Shortlist")}  style={styles.extraText}> Add to Shortlist</Text>
        </TouchableOpacity>
      </View>

      <View style={styles.extraBtnRow}>
        <TouchableOpacity style={styles.extraBtn}>
          <Icon name="share" size={18} color="purple" />
